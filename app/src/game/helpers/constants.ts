...
export const DEPTH_GRID_SQUARES = 10;
export const DEPTH_GO_DEFAULT_BLOCK = 12;
export const DEPTH_GO_PORTAL_BLOCK = 13;
export const DEPTH_GO_GOTCHI = 18;
export const DEPTH_GO_GOTCHI_BLOCK = 13;
...
export const DEPTH_ACTIONS_REMAINING_TEXT = 90;
