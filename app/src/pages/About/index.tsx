  ...
  return (
    <Layout>
      <div className={styles.container}>
        ...
        <h1>Tips</h1>
        <p>If you enjoyed the game feel free to send any spare GHST to:</p>
        <p>0x636Db7553Dfb9c87DCe1a5edF117EDCAff1B650a</p>
        <p>Your support is greatly appreciated! However, if you did not like the game, feel free to drop me a message on 
          discord with any feedback or improvements that I can make for the future :) </p>
